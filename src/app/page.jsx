...
export default function Home() {
  return (
    <main className="mx-40 home-page-main">
      <div className="grid grid-cols-5 gap-20">
        <div className="h-full grid col-span-3 content-between">
          <div className="mr-20">
            ...
            <div className="flex mt-12">
              <button className="bg-FFD400 rounded-full bg-white px-6 py-5 mr-2.5 button-main-page flex content-center justify-center font-semibold">
                <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M5.125 4.5V5.25H3.13787C2.17832 5.25 1.37362 5.97444 1.27317 6.92872L0.010015 18.9287C-0.106519 20.0358 0.761522 21 1.87471 21H17.3754C18.4886 21 19.3567 20.0358 19.2401 18.9287L17.977 6.92872C17.8765 5.97444 17.0718 5.25 16.1123 5.25H14.125V4.5C14.125 2.01472 12.1103 0 9.625 0C7.13972 0 5.125 2.01472 5.125 4.5ZM9.625 1.5C7.96815 1.5 6.625 2.84315 6.625 4.5V5.25H12.625V4.5C12.625 2.84315 11.2819 1.5 9.625 1.5ZM6.625 9.75C6.625 11.4069 7.96815 12.75 9.625 12.75C11.2819 12.75 12.625 11.4069 12.625 9.75V9C12.625 8.58579 12.9608 8.25 13.375 8.25C13.7892 8.25 14.125 8.58579 14.125 9V9.75C14.125 12.2353 12.1103 14.25 9.625 14.25C7.13972 14.25 5.125 12.2353 5.125 9.75V9C5.125 8.58579 5.46079 8.25 5.875 8.25C6.28921 8.25 6.625 8.58579 6.625 9V9.75Z" fill="#262626"/>
                </svg>
                <p className="ml-2">Shop Now</p>
              </button>
              <button className="border border-F1F1F3 rounded-full bg-white px-6 py-5 button-main-page content-self-center justify-self-center font-semibold button-defult">
                Contact Us
              </button>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-5 p-5 bg-F7F7F8 home-page-main-contener rounded-xl">
        ...
        <div className="col-span-2 relative rounded-[20px] bg-F1F1F3 home-page-main-image-area">
          <Image
          ...
          <div className="absolute top-0 h-full w-full py-10 px-5 grid content-between">
            ...
            <div className="flex justify-between">
              ...
              <div className="rounded-full bg-white py-2 px-4 flex cursor-default">
                <p>View Similar</p>
                <svg className="my-1" xmlns="http://www.w3.org/2000/svg" height="15px" width="24px" viewBox="0 0 24 24" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg>
              </div>
            </div>
          </div>
        </div>
